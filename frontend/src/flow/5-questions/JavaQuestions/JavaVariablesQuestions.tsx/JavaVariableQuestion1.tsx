...
//                         <Question text={INITIALIZING_VARIABLES_QUESTIONS.INITIALIZATION_QUESTION_1} />
//                     </div>
...
//                     <AnswerExplanationHeader correct={INITIALIZING_VARIABLES_QUESTION_1_BOOLEANS.ANSWER_1} />
//                     <div className="answer-jawn">
