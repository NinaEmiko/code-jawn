...
export default function HomeScreen() {
    ...
    const [lessonTracker, setLessonTracker] = useState<LessonTracker>(getDefaultLessonTracker());
    const [activeLanguage, setActiveLanguage] = useState<string>(LANGUAGES[0].language);
    const [activeDescription, setActiveDescription] = useState<string>(LANGUAGES[0].description);
    const [activeRoute, setActiveRoute] = useState<string>(LANGUAGES[0].route);
    const [selectedButton, setSelectedButton] = useState<number>(0);
    const [activeProgress, setActiveProgress] = useState<number>(Math.round(javaProgressCalculator(getDefaultLessonTracker().javaLT)));
